...
public class CSVParser {
    ...
    public static FlightGraphInterface parseCSVToLinkedListGraph(String filePath) throws IOException {
        ...
        try {
            ...
            FlightGraphInterface graph = (FlightGraphInterface) linkedListGraphClass.getDeclaredConstructor()
                    .newInstance();
            return parseCSVToGraph(filePath, graph);
        } catch (Exception e) {
    ...
    public static FlightGraphInterface parseCSVToDoublyLinkedListGraph(String filePath) throws IOException {
        ...
        try {
            ...
            FlightGraphInterface graph = (FlightGraphInterface) doublyLinkedListGraphClass.getDeclaredConstructor()
                    .newInstance();
            return parseCSVToGraph(filePath, graph);
        } catch (Exception e) {
    ...
    public static FlightGraphInterface parseCSVToTwoDArrayGraph(String filePath) throws IOException {
        ...
        try {
            ...
            FlightGraphInterface graph = (FlightGraphInterface) twoDArrayGraphClass.getDeclaredConstructor()
                    .newInstance();
            return parseCSVToGraph(filePath, graph);
        } catch (Exception e) {
    ...
    /**
     * Parse CSV file and populate the LinearArray-based flight graph
     * 
     * @param filePath path to the CSV file
     * @return populated LinearArrayGraph.LinearArrayFlightGraph object
     * @throws IOException if file cannot be read
     */
    public static FlightGraphInterface parseCSVToLinearArrayGraph(String filePath) throws IOException {
        // Create LinearArray-based graph using reflection to avoid import issues
        try {
            Class<?> linearArrayGraphClass = Class.forName("LinearArrayGraph.LinearArrayFlightGraph");
            FlightGraphInterface graph = (FlightGraphInterface) linearArrayGraphClass.getDeclaredConstructor()
                    .newInstance();
            return parseCSVToGraph(filePath, graph);
        } catch (Exception e) {
            throw new IOException("Failed to create LinearArray-based FlightGraph: " + e.getMessage());
        }
    }
