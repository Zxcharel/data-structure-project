...
/**
 * CSV loader specifically for DynamicArrayFlightGraph
 * This bypasses the CSVParser reflection issues
 */
public class DynamicArrayCSVLoader {
    
    public static DynamicArrayFlightGraph loadFromCSV(String filePath) throws IOException {
        DynamicArrayFlightGraph graph = new DynamicArrayFlightGraph();
